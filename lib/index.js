...
function copy(from, to) {
  return Object.assign(function (context) {
    ...
    context.copyPlugin = (0, _deepmerge2.default)(context.copyPlugin, config, { clone: true }); // eslint-disable-line fp/no-mutation
...
function copyOptions(options) {
  return Object.assign(function (context) {
    ...
    context.copyPlugin = (0, _deepmerge2.default)(context.copyPlugin, { options: options }, { clone: true }); // eslint-disable-line fp/no-mutation
...
function postConfig(context) {
  ...
  var plugin = new _copyWebpackPlugin2.default(patterns, options); // eslint-disable-line better/no-new
